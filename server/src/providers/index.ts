...
import { piCrewProvider } from './hook/pi-crew/piCrew.js';

export { claudeProvider, piCrewProvider };
...
export const hookProviders: readonly HookProvider[] = [claudeProvider, piCrewProvider];
